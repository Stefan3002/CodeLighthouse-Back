...
# Create the plain-text and HTML version of your message
def format_new_admin_email(username, challenge_name, announcement_content, admin_email):
    html = f"""\
    <html>
      <body>
        <p>
        ...
        <p>Feel free to reply to this e-mail for more information.</p>
      </body>
    </html>
    """
    new_admin_message["Reply-To"] = admin_email
    # Turn these into plain/html MIMEText objects
    part = MIMEText(html, "html")
